...
sd_client = Client("stabilityai/stable-diffusion-3.5-large")
vto_client = Client("AI-Platform/Virtual-Try-On")

# Streamlit app
st.title("Image Generation and Virtual Try-On")

# Section for Stable Diffusion
